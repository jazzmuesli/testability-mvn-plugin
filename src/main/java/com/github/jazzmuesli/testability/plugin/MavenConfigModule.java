...
public class MavenConfigModule extends AbstractModule {
  ...
  private TestabilityMojo testabilityExplorerMojo;

  public MavenConfigModule(TestabilityMojo testabilityExplorerMojo) {
  ...
  protected void configure() {
    ...
    bind(TestabilityMojo.class).toInstance(testabilityExplorerMojo);
  ...
  @Provides ClassRepository getClassRepo(TestabilityMojo mojo) {
    return new JavaClassRepository(mojo.getProjectClasspath());
  }

  @Provides @Output PrintStream getOutput(TestabilityMojo mojo, ReportFormat format) {
  ...
  @Provides @Error PrintStream getError(TestabilityMojo mojo) {
